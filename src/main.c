...
GColor bg_color, hour_color, min_color, week_color, sun_color, date_color;
...
static void window_load(Window *my_window){
  ...
  // ++++++ text color +++++++
  #ifdef PBL_COLOR
    GColor hour_color = GColorVividCerulean;
  GColor min_color = GColorVividCerulean; // GColorMalachite GColorPictonBlue
  GColor week_color = GColorWhite;
  GColor sun_color = GColorRed;
  ...
  text_layer_set_text_color(test_layer, hour_color);
  ...
  text_layer_set_text_color(hour_layer, hour_color);
  ...
  text_layer_set_text_color(min_layer, min_color);
